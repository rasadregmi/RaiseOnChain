...
import { donateToCampaign } from '../services/contractService';
...
const DonationModal = ({ campaign, isOpen, onClose }) => {
  ...
  const handleDonate = async (e) => {
    ...
    if (!isCorrectNetwork) {
      console.log('Wrong network, attempting to switch to Localhost 8545...');
      try {
    ...
    if (donationAmountFloat > balanceFloat) {
      setError(`Insufficient balance. You have ${balanceFloat} ETH but trying to donate ${donationAmountFloat} ETH`);
      return;
    }
    ...
    try {
      ...
      const result = await donateToCampaign(campaign.id, donationAmount);
      
      console.log('Donation transaction completed successfully:', result);
      setSuccess(true);
        ...
        {success ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">
              Your donation of {donationAmount} ETH has been sent to "{campaign.title}"
            </p>
          </div>
        ) : (
          <>
            <div className="mb-6">
              ...
              <div className="flex justify-between text-sm text-gray-600">
                ...
                <span>Raised: {campaign.raised.toFixed(1)} ETH</span>
              </div>
            </div>
            ...
            {isConnected && !isCorrectNetwork && (
              <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-sm text-yellow-700 mb-3">
                  You're currently on {getNetworkName(currentNetwork)}. Please switch to Localhost 8545 to donate.
                </p>
                <button
            ...
            {!isConnected ? (
              <div className="mb-6">
                <p className="text-gray-600 mb-4">
                  Connect your wallet to make a donation on Localhost 8545
                </p>
                <button
